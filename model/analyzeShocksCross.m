...
for i = 1:n_yrs % for each year
    ...
    % original surpluses
    consumer_surplus_0 = output(:,6);
    producer_surplus_0 = output(:,6);
    ...
    results_matrix(row_range,column_range) = [                          ...
                ...
                consumer_surplus_pct_change, producer_surplus_0,        ...
                consumer_surplus_0, data_quantities];
    ...
    if format_results % save time by setting this to false
        ...
        for j = 1:num_countrycrop % for each country   
            ...
            formatted_results = [formatted_results; {(i),               ...
                            ...
                            producer_surplus_0(j),                      ...
                            consumer_surplus_0(j),                      ...
                            data_quantities(j)];
